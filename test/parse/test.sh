...
declare -A test_cases=(
    ...
    ["rt_file/common/empty.rt"]=1
    ["rt_file/common/malformed_vec.rt"]=1
    ["rt_file/common/invalid_numbers.rt"]=1
    ["rt_file/common/case_sensitivity.rt"]=1
    
    # Success case
    ["rt_file/success.rt"]=0
    ["rt_file/_sp/success.rt"]=0
)
